...
contract Superpanda is Context, IERC20, Ownable {
    ...
    string private _name = "Superpanda";
    string private _symbol = "SPANDA";
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out from Superpanda");
